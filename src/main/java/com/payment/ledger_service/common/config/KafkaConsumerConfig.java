package com.payment.ledger_service.common.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, PaymentConfirmMessage> paymentConfirmConsumerFactory() {
        ...
        props.put(JacksonJsonDeserializer.TYPE_MAPPINGS, "PaymentConfirmMessage:com.payment.ledger_service.ledger.domain.PaymentConfirmMessage");
